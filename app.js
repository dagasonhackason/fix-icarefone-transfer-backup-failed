...
console.log("str-full", ICAREFONE_TRANSFER_BACKUP_FOLDER_PATH);
console.log("str-cut-out", getLastButOneItemInPath(ICAREFONE_TRANSFER_BACKUP_FOLDER_PATH));
...
//             itemsProcessed++;
//             if(itemsProcessed === totallength) {
//                 timer = setTimeout(function () { resolver(resa); }, 125094);
//             }
